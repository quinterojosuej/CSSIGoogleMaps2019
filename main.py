...
# Do use this environment and two classes, otherwise things will not work
# The third is to keep track of the user's input, not necessary for MVP's 
...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        # If data is not going to be manually added input it to this dictionary.
        # Othewise delete it or do not use it in line 67
        myDict = {
            'address_from_python_dict':'Salinas'
        }
